...
-   [Puppet tasks and plans](writing_tasks_and_plans.md)
    ...
    -   [Writing plans](writing_plans.md#concept-7890)
        ...
        -   [Applying manifest blocks](applying_manifest_blocks.md#concept-4926)
            -   [How manifest blocks are applied](manifest_blocks_about.md#concept-3038)
                -   [Options](manifest_blocks_about.md#concept-4462)
                -   [Return Value of Apply Action](manifest_blocks_about.md#concept-6048)
                -   [Configuring Concurrency](manifest_blocks_about.md#concept-3562)
