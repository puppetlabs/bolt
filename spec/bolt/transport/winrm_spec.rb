...
describe Bolt::Transport::WinRM do
  ...
  # HACK: AppVeyor cert is generated by a different CA than TravisCI cert
  let(:cacert_path) { RSpec.configuration.filter.rules[:omi] ? 'spec/fixtures/ssl/ca.pem' : 'resources/ca.pem' }
