...
describe Bolt::Application do
  ...
  describe '#file_download' do
    ...
    it 'downloads a file' do
      ...
      application.download_file(source, destination, targets)
    end
  end
  ...
  describe '#file_upload' do
    ...
    it 'uploads a file' do
      stub_file(source)
      expect(executor).to receive(:upload_file).with(targets, source, destination)

      application.upload_file(source, destination, targets)
    end

    it 'uploads a directory' do
      stub_directory(source)
      allow(Dir).to receive(:foreach).and_return([])
    ...
    it 'errors if the source does not exist' do
      ...
      expect { application.upload_file(source, destination, targets) }.to raise_error(
        Bolt::FileError,
  ...
  describe '#plan_run' do
    ...
    it 'runs a given plan' do
      ...
      application.run_plan(plan, targets)
    end
  ...
  describe '#script_run' do
    ...
    it 'runs a script' do
      ...
      application.run_script(script, targets)
    end

    it 'errors if the script does not exist' do
      stub_nonexistent_file(script)

      expect { application.run_script(script, targets) }.to raise_error(
        Bolt::FileError,
  ...
  describe '#task_run' do
    ...
    it 'runs a given task' do
      ...
      application.run_task(task, targets)
    end
  end
end
