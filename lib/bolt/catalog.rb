    ...
    def compile_catalog(request)
      ...
      with_puppet_settings(request['hiera_config']) do
        ...
        Puppet::Pal.in_tmp_environment('bolt_catalog',
          ...
          pal.with_catalog_compiler do
            loader = Puppet.lookup(:loaders).private_environment_loader
            loader.load(:type, 'result')
            loader.load(:type, 'applytarget')
            loader.load(:type, 'applyresult')
            loader.load(:type, 'resultset')
            ...
            Puppet.override(bolt_pdb_client: pdb_client) do
              ...
              pal.with_catalog_compiler(variables: vars) do |compiler|
